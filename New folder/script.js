...
const renderCalendar = () => {
    let firstDayofMonth = new Date(currYear, currMonth , 1).getDay(), //getting first day to month
...
prevNextIcon.forEach(icon => {
    icon.addEventListener("click", () => { //adding click event on both icons
        // if clickes icon is previous icon then decrement current month by 1 else increment it by 1
